    ...
    def item_organizer(self, obj):
        ...
        if organizer_dic:
            if isinstance(organizer_dic, dict):
                ...
                for key, val in six.iteritems(organizer_dic):
                    if key is not 'email':
...
class ICal20FeedTest(TestCase):
    ...
    def test_items(self):
        ...
        self.assertEquals(calendar.subcomponents[0]['DTSTART'].to_ical(), six.b('20120501T180000'))
        self.assertEquals(calendar.subcomponents[0]['DTEND'].to_ical(), six.b('20120501T200000'))
        ...
        self.assertEquals(calendar.subcomponents[0]['ORGANIZER'].to_ical(),
                          six.b("MAILTO:john.doe@example.com"))
        ...
        self.assertEquals(calendar.subcomponents[1]['DTSTART'].to_ical(), six.b('20120506T180000'))
        self.assertEquals(calendar.subcomponents[1]['DTEND'].to_ical(), six.b('20120506T200000'))
